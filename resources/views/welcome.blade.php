...
<head>
    ...
    <script type="text/javascript" src="assets/js/modernizr.custom.08464.js"></script>
...
<div id="flip" class="container">
    ...
    <div class="f-page">
        ...
        <div class="box w-40 h-50 box-img-left box-b-r title-top">
...
<script type="text/javascript">
    ...
    Modernizr.load({
        ...
        yep : ['assets/js/jquery.tmpl.min.js','assets/js/jquery.history.js','assets/js/core.string.js','assets/js/jquery.touchSwipe-1.2.5.js','assets/js/jquery.flips.js'],
        nope: 'assets/css/fallback.css',
        callback : function( url, result, key ) {

            if( url === 'assets/css/fallback.css' ) {
                $pages.show();
            }
            else if( url === 'assets/js/jquery.flips.js' ) {
                $container.flips();
            }
